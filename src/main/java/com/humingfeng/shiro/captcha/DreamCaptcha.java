package com.humingfeng.shiro.captcha;

import com.humingfeng.util.StringTools;
...
/**
     * @ProjectName:
     * @Package:        com.humingfeng.shiro.captcha
     * @ClassName:      DreamCaptcha
     * @Description:    验证码操作类
     * @Author:         胡铭锋
     * @CreateDate:     2018/9/25 17:29
     * @Version:        1.0
     */
@Component
public class DreamCaptcha implements InitializingBean {
	...
	public void generate(HttpServletRequest request, HttpServletResponse response) {
		...
		if (StringTools.isNullOrEmpty(cookieValue)) {
			hasCookie = false;
			cookieValue = StringTools.getUUId();
		}
	...
	public boolean validate(HttpServletRequest request, HttpServletResponse response, String userInputCaptcha) {
		...
		if (StringTools.isNullOrEmpty(captchaCode)) {
			return false;
		}
		// 转成大写重要
